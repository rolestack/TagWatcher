...
async def lifespan(app: FastAPI):
    ...
    if database.is_initialized():
        from app.services.scheduler import scheduler, register_host_job, register_maintenance_jobs
...
from app.routers import auth, dashboard, spaces, docker_hosts, containers, channels, admin, account, agent_api  # noqa: E402
